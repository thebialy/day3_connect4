...
// win condition function
  ...
  function winCondtion() {
    const winningArrays = [
        ...
        for(let x = 0; x < winningArrays.length; x++) {
            const square1 = squares[winningArrays[x][0]]
            const square2 = squares[winningArrays[x][1]]
            const square3 = squares[winningArrays[x][2]]
            const square4 = squares[winningArrays[x][3]]
  ...
  // event listener attached to each square to check winCondtion function
  squares.forEach(square => square.addEventListener('click', winCondtion))
